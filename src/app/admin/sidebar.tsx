...
export function AdminSidebar({ user }: { user: User }) {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-64 bg-[hsl(var(--card))] border-r border-[hsl(var(--border))] flex flex-col">
      <div className="p-5 border-b border-[hsl(var(--border))]">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div>
            <span className="font-semibold text-sm">정보보호과</span>
      ...
      <div className="p-3 border-t border-[hsl(var(--border))]">
        <div className="flex items-center gap-3 px-3 py-2 mb-2">
          <div className="w-8 h-8 rounded-full bg-[hsl(var(--secondary))] flex items-center justify-center text-xs font-medium">
        ...
        <Link
          href="/"
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-[hsl(var(--muted-foreground))] hover:text-white hover:bg-[hsl(var(--secondary))] transition-colors"
        >
